...
import reviewsData from "/Akash/GK_WEBSITE/GK_WEBSITE/googleReviews.json";
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-10 gap-6">
          <div className="flex items-center gap-4">
            <div className="bg-white p-3 rounded-2xl shadow-sm border border-gray-100">
              <img src="/Google.png" alt="Google" className="w-8 h-8 object-contain" />
            </div>
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Google Rating</h2>
              <div className="flex items-center gap-2">
                <span className="text-xl font-bold text-gray-800">{reviewsData.overallRating}</span>
        ...
        <div className="relative group">
          <div className="overflow-hidden py-4">
            <div
              ...
              style={{ transform: `translateX(-${current * (100 / (window.innerWidth < 768 ? 1 : 3))}%)` }}
            >
              {reviewsData.reviews.map((item, index) => (
                ...
                >
                  <div className="bg-white border border-gray-100 rounded-xl p-6 shadow-sm hover:shadow-md transition-all flex flex-col w-full relative">
                    {/* Google Icon on Card */}
                    <img src="/Google.png" className="absolute top-6 right-6 w-5 h-5 opacity-20" alt="" />
