...
const MetalTesting = () => {
  ...
  const features = [
    ...
    {
      title: "Traditional & Modern Methods",
      desc: "We use a mix of touchstone testing, XRF technology, and practical experience for reliable outcomes.",
      icon: Zap,
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-16 px-4 md:px-8">
      ...
      {/* FAQ */}
      <FAQSection title="Metal Testing FAQs" faqs={globalFaqs} />
    </div>
  );
};
...
//             <p className="text-gray-600 text-lg mb-6 leading-relaxed">
//               We provide professional metal testing services to identify metal
//               type and purity with accuracy and honesty.
//             </p>
//           </div>
