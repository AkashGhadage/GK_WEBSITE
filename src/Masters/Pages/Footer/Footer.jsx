    ...
    <footer className="w-full bg-[rgb(23,28,32)] text-gray-200 pt-16 pb-8 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1fr] gap-y-12 gap-x-6 mb-16">
          ...
          {/* FIX: Added gap-y-12 for mobile stacking and md:gap-y-0 for desktop */}
          <div className="lg:col-span-3 grid grid-cols-1 sm:grid-cols-3 gap-x-6 gap-y-12 sm:gap-y-0">
            
            {/* Expertise */}
            <div className="flex flex-col">
              <h4 className="text-sm font-bold tracking-[0.3em] uppercase text-white border-b border-[#CFA04F]/30 pb-2 inline-block mb-5 self-start">
                Expertise
              </h4>

              <ul className="space-y-3 text-sm text-gray-400">
                <li>
                  <Link to="/services/gold-silver-testing" className="hover:text-[#CFA04F] transition-colors">
                    Gold & Silver Testing
                  </Link>
                </li>
                <li>
                  <Link to="/services/computer-touch" className="hover:text-[#CFA04F] transition-colors">
                    Computer Touch (Tunch)
                  </Link>
                </li>
                <li>
                  <Link to="/services/jewellery-repair" className="hover:text-[#CFA04F] transition-colors">
                    Jewellery Repair
                  </Link>
                </li>
                <li>
                  <Link to="/services/metal-testing" className="hover:text-[#CFA04F] transition-colors">
                    Metal Analysis
                  </Link>
                </li>
              </ul>
            ...
            <div className="flex flex-col">
              ...
              <ul className="space-y-3 text-sm text-gray-400">
                <li>
                  <Link to="/home" className="hover:text-[#CFA04F] transition-colors">Home</Link>
                </li>
                <li>
                  <Link to="/about" className="hover:text-[#CFA04F] transition-colors">About</Link>
                </li>
                <li>
                  <Link to="/gold_silver" className="hover:text-[#CFA04F] transition-colors">Gold & Silver</Link>
                </li>
                <li>
                  <Link to="/contact" className="hover:text-[#CFA04F] transition-colors">Contact</Link>
                </li>
              </ul>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <div className="space-y-3 text-sm text-gray-400">
                ...
                <div className="flex gap-3 items-center">
                  ...
                  <a href="tel:+919075516373" className="hover:text-white transition-colors">
                    +91 90755 16373
                  </a>
                </div>
                ...
                <div className="flex gap-3 items-center">
                  <FaPhoneAlt className="text-[#CFA04F] shrink-0" />
                  <a href="tel:+917011675610" className="hover:text-white transition-colors">
                    +91 70116 75610
                  </a>
                </div>
                ...
                <div className="flex gap-3 items-center">
                  ...
                  <a href="mailto:gurukrupagoldtunch@gmail.com" className="hover:text-white transition-colors">
